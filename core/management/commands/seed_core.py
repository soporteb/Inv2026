...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        for name in ["CPU", "Laptop", "Server", "Monitor", "Keyboard", "Teclado", "Printer", "Switch", "Access Point", "Webcam", "Headphones", "Microphone", "PC Speaker", "Teleconference", "Projector", "Interactive Whiteboard", "Air Conditioner", "Biometric Clock", "Tablet", "Sound Console"]:
